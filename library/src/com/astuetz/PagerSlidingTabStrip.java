...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof IconTabProvider) {
                ...
                /* Add linear layout containing text and counter textviews*/
                addTabLayout(i, pager.getAdapter().getPageTitle(i).toString());
            }
    ...
    private void updateTabStyles() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            /* Set the linear layout background drawable*/
            LinearLayout tabLayout = (LinearLayout) tabsContainer.getChildAt(i);
            tabLayout.setBackgroundResource(!tabSwitch ? tabBackgroundResId : transparentColorId);

            /* Set the style only for the first text view */
